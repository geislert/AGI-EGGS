...
See [FUSION_CONTROL.md](docs/FUSION_CONTROL.md) for notes on plasma fusion concepts used as background inspiration.
See [PRESIDENTIAL_JURISDICTION.md](docs/PRESIDENTIAL_JURISDICTION.md) for a summary of the jurisdiction assertion text.
